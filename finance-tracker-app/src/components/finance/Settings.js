        ...
        <div className="accordion-item setting-accordion">
          ...
          >
            <div className="accordion-body">
              <p>Stay up to date with important alets and updates. Customize your notifications preferences to receive remiders about budget limits, saving goal and acount activity.</p>
...
<div class="form-check form-check-inline">
  ...
  <label class="form-check-label" for="inlineRadio2">No</label>
        ...
        <div className="accordion-item setting-accordion">
          ...
          >
            <div className="accordion-body">
              <p>Secure your finance data with regular backups. Enable automatic backups to ensure your information is safely stored and can be stored at any time.</p>
              <button type="button" className="btn mt-3 backup-btn">Back up</button>
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item setting-accordion">
          ...
          >
            <div className="accordion-body">
              <p>Need assistance? Access our help center for tutorials, FAQs and customer support to guide you through using the finance tracker.</p>
              <a href='#' className='contact-link'>Contact us</a> for more details.
            </div>
          </div>
        </div>
        ...
        <div className="accordion-item setting-accordion">
          <h2 className="accordion-header" id="panelsStayOpen-headingThree">
            <button
              className={`accordion-button ${!accordionState.itemFourOpen ? 'collapsed' : ''}`}
              type="button"
              data-bs-toggle="collapse"
          ...
          <div
            id="panelsStayOpen-collapseThree"
            className={`accordion-collapse collapse ${accordionState.itemFourOpen ? 'show' : ''}`}
            aria-labelledby="panelsStayOpen-headingThree"
          >
            <div className="accordion-body">
            <p>Your privacy matters to us. Learn more about how we protect your personal and financial information in our comprehensive privacy policy.</p>
            <a href='#' className='contact-link'>Contact us</a> for more details.
            </div>
          </div>
        </div>
